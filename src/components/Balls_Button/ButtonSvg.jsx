...
const ButtonSvg = (white) => (
  <>
    ...
    >
      <path
        fill={white ? "#612010" : "black"}
        stroke={white ? "#612010" : "url(#btn-left)"} // mentioned in ButtonGradient.jsx
        strokeWidth="2"
    ...
    >
      <path
        fill={white ? "#612010" : "black"}
        stroke={white ? "#612010" : "url(#btn-right)"} // mentioned in ButtonGradient.jsx
        strokeWidth="2"
